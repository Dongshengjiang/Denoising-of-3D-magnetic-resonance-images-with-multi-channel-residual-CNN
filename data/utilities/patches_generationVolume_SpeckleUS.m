function [inputs, labels] = patches_generationVolume_SpeckleUS(size_input,size_label,stride,t1Input,t1Training,batchSize)
        ...
        for j=1:8
            ...
            for x = 1 : stride : (hei-size_input+1)
                for y = 1 :stride : (wid-size_input+1)
                    ...
                    if numel(find(subim_label<0.01))<800
                        count       = count+1;
